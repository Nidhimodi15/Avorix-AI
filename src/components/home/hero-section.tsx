...
export function HeroSection() {
  return (
    <section className="relative pt-24 pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-gradient-hero">
      ...
      <div
        className="absolute top-1/4 left-[5%] w-64 h-64 rounded-full blur-[80px] -z-0 animate-float-slow opacity-60 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(37,99,235,0.35), transparent)' }}
      />
      <div
        className="absolute bottom-1/4 right-[8%] w-80 h-80 rounded-full blur-[100px] -z-0 animate-float-delayed opacity-40 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.3), transparent)' }}
      />
      <div
        className="absolute top-0 right-1/4 w-48 h-48 rounded-full blur-[60px] -z-0 animate-float opacity-30 pointer-events-none"
